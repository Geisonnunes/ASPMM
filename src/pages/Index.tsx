...
const upcomingEvents: Array<{
...
}> = [
  {
    ...
    description:
      "Torneio entre equipes de associados. Inscrições abertas até 15/04.",
    attendees: 48,
    image: campoSociety,
    status: "aberto",
  },
  {
    ...
    description:
      "Venha celebrar com comidas típicas, quadrilha e muita diversão!",
    attendees: 120,
    image: salaoFestas,
    status: "em breve",
  },
  {
    ...
    description:
      "Aula gratuita para associados e dependentes. Todos os níveis.",
    attendees: 24,
    image: quadraAreia,
    status: "aberto",
  },
...
const featuredFacilities = [
  {
    name: "Campo Society",
    description: "Dois campos de grama sintética com iluminação noturna.",
    capacity: 14,
    rating: 4.8,
    image: campoSociety,
  },
  {
    name: "Piscina",
    description: "Piscina semiolímpica com área de descanso e quiosque.",
    capacity: 80,
    rating: 4.9,
    image: piscina,
  },
  {
    ...
    description: "Quadra oficial para vôlei e futevôlei.",
    capacity: 20,
    rating: 4.7,
    image: quadraAreia,
  },
  {
    ...
    description: "Espaço climatizado para eventos e confraternizações.",
    capacity: 200,
    rating: 4.6,
    image: salaoFestas,
  },
